...
public class DetailedInformationCentreWithYoutube extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detailed_information_centre_with_youtube);
...
//        description = findViewById(R.id.description);
        ...
        ytPlayer.initialize(api_key, new YouTubePlayer.OnInitializedListener() {
            ...
            public void onInitializationFailure(YouTubePlayer.Provider provider, YouTubeInitializationResult youTubeInitializationResult) {
                Toast.makeText(DetailedInformationCentreWithYoutube.this, "Video Player Failed", Toast.LENGTH_SHORT).show();
            }
        });
